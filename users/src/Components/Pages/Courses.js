    ...
    <div className="mt-4">
      <div className="container">
        <div className="schedule_btn mt-2">
          <NavLink className="btn btn-primary" to="/createCourse"> Create Course</NavLink>
        </div>
          ...
          <tbody>
			  {
				...
				<td className="d-flex justify-content-between">
                  <NavLink to={`course/${element._id}`}><button className="btn btn-success "><i className="fa-regular fa-eye"></i></button></NavLink>
                  <NavLink to={`/updateCourse/${element._id}`}><button className="btn btn-primary "><i className="fas fa-pen"></i></button></NavLink>
